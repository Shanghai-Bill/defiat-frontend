...
//== modifiers ==
    ...
    constructor(address _governance) public { //token and governing contract
        deFiat_Gov[_governance] = true; //whitelist the governor contract
        deFiat_Gov[msg.sender] = true; //msg.sender is the 1st governor
        _constructor("DeFiat Points Rinkeby", "r_DFT.P"); //calls the ERC20 "_constructor" to update token name
...
//== MINT points onlyToken ==  
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override virtual {
        ...
        //force update discount on point transfer
        uint256 _tranche = viewEligibilityOf(msg.sender);
